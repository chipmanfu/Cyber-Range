...
case $opt in 
  ...
  3) clear; echo -e "$green Installing $svr Specific Applications $default";
     ...
     openssl genrsa -aes256 -out private/ca.$CA.key.pem 4096 -passout pass:$capempass
     ...
     openssl req -config intermediate/openssl_intermediate.cnf -extensions v3_intermediate_ca -days 3650 -notext -md sha512 -in /root/CA/intermediate/csr/int.$CA.csr -out /root/CA/intermediate/certs/int.$CA.crt.pem -passin pass:$capempass
