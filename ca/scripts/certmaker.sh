...
openssl pkcs12 -inkey /root/ca/intermediate/private/$domain.key -in /root/ca/intermediate/certs/$domain.crt -export -chain -CAfile /root/ca/intermediate/certs/chain.CADOMAINNAME.crt.pem -out /root/ca/intermediate/certs/$domain.p12 -passout pass:CAPASSWORD $addalias
