...
openssl pkcs12 -inkey /root/ca/intermediate/private/cs.$domain.key -in /root/ca/intermediate/certs/cs.$domain.crt -export -chain -CAfile /root/ca/intermediate/certs/chain.CADOMAINNAME.crt.pem -out /root/ca/intermediate/certs/cs.$domain.p12 -passout pass:CAPASSWORD 
